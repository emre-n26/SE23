...
public interface QuotesService {
   ...
   */
  VotableQuote getQuote(int index);
   ...
   */
  List<VotableQuote> getAllQuotes();

  /**
   * The method up- or down-votes a Chuck Norris quote.
   * @param index - The position of the quote that is to be deleted from the list.
   * @param upOrDown - Either +1 if the quote should be upvoted or -1 if the quote should be downvoted.
   * @throws IllegalArgumentException - Throws IllegalArgumentException if index or upOrDown is out of range.
   */
   void voteQuote(int index, int upOrDown);
